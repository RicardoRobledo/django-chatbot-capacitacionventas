...
class ChromaSingleton():
    ...
    def __get_connection(cls, embedding_function):
        ...
        client = Chroma(client=client, collection_name="capacitacion_ventas", embedding_function=embedding_function)
    ...
    async def create(cls):
        ...
        Chroma.from_documents(splitter_docs, collection_name="capacitacion_ventas", persist_directory="chroma_db", embedding=cls.__embeddings)
